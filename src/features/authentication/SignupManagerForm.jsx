...
import { useSignupManager } from '../user/useSignupManager';
...
function SignupManagerForm() {
    const { signupManager, isLoadingSignup } = useSignupManager();
    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}>
            <FormRow label="Tên quản lý" error={errors?.name?.message}>
                <Input
                    type="text"
                    id="name"
